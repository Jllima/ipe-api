...
@NamedQueries({
    ...
    @NamedQuery(name = "Encaminhamento.findById", query = "SELECT e FROM Encaminhamento e WHERE e.id = :id")})
public class Encaminhamento implements Serializable {
    ...
    @ManyToMany(mappedBy = "encaminhamentoCollection")
    ...
    public String toString() {
        return "br.gov.ce.fortaleza.sesec.ipeapi.entities.Encaminhamento[ id=" + id + " ]";
    }
